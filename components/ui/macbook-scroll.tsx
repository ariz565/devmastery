    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {src ? (
          ...
          <div className="absolute inset-0 rounded-lg bg-[#1a1a1a] flex flex-col">
            ...
            {/* Code Content */}
            <div className="flex-1 p-4 font-mono text-sm text-white overflow-hidden">
              ...
              <div className="absolute top-16 left-12 space-y-1 text-xs">
                <div>
                ...
                <div>
                  ...
                  <span className="text-blue-400">DevMastery</span>{" "}
                  <span className="text-white">=</span>{" "}
                  <span className="text-white">() =&gt; &#123;</span>
                </div>
                <div className="ml-4">
                  ...
                  <span className="text-white">,</span>{" "}
                  <span className="text-blue-300">setSkills</span>
                  <span className="text-white">] =</span>{" "}
                ...
                <div className="ml-8">
                  ...
                  <span className="text-white">=</span>
                  <span className="text-green-300">"learning-platform"</span>
                  <span className="text-red-400">&gt;</span>
                </div>
                <div className="ml-12">
                  <span className="text-red-400">&lt;h1&gt;</span>
                  <span className="text-white">Master Your Skills</span>
                  <span className="text-red-400">&lt;/h1&gt;</span>
                </div>
                <div className="ml-8">
                  <span className="text-red-400">&lt;/div&gt;</span>
